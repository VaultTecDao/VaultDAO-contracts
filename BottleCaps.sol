...
contract BottleCaps is ERC20Permit, Ownable {
    ...
    constructor() ERC20("BottleCaps", "BottleCaps", 9) ERC20Permit() {
    ...
    /**
        @notice increases BottleCaps supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess BottleCaps
